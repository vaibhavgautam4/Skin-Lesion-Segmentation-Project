...
def load_data(dataset_path, split = 0.2):
    ...
    # training = sorted(glob(os.path.join(dataset_path, "ISIC2018_Task1-2_Training_Input", "*.jpg")))
    ...
    # testing = sorted(glob(os.path.join(dataset_path, "", "*.jpg")))
...
if __name__ == "__main__":
    ...
    # dataset_path = "D:/segmentation/dataset"
    ...
    # model = ResNet(input_shape=(h, w, 3), num_classes=1)
